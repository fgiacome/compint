...
parser.add_argument(
    "--episodes", type=int, default=10_000, help="Number of training episodes"
)
parser.add_argument(
    "--save_period", type=int, default=100, help="How often to generate a new adversary"
)
parser.add_argument(
    "--checkpoint_period", type=int, default=100, help="How often to save a checkpoint"
)
parser.add_argument(
    "--load_in_folder",
    action="store_true",
    help="Wether to load all .mdl files in the current folder in the opponents pool",
)
parser.add_argument(
    "--episode_count", type=int, default=0, help="Start episode count from..."
)
